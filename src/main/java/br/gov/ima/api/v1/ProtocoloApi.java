...
public class ProtocoloApi {
	 ...
	 */
	public List<ProtocoloResponse> protocoloGet (String clientId, String offset, String limit, List<String> fields, List<String> filters) throws ApiException {
	 ...
	 */
	public ProtocoloResponse protocoloIdGet (String clientId, Long id, List<String> fields) throws ApiException {
