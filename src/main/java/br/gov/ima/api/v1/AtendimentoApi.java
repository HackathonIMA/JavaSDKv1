...
public class AtendimentoApi {
	 ...
	 */
	public List<SolicitacaoResponse> atendimentoGet (String clientId, String offset, String limit, List<String> fields, List<String> filters) throws ApiException {
	 ...
	 */
	public SolicitacaoResponse atendimentoIdGet (String clientId, String id, List<String> fields) throws ApiException {
