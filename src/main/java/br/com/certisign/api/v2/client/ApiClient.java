package br.gov.ima.api.v1.client;
...
import br.gov.ima.api.v1.client.auth.Authentication;
import br.gov.ima.api.v1.client.auth.HttpBasicAuth;
import br.gov.ima.api.v1.client.auth.ApiKeyAuth;
import br.gov.ima.api.v1.client.auth.OAuth;

public class ApiClient {
	private Map<String, Client> hostMap = new HashMap<String, Client>();
	private Map<String, String> defaultHeaderMap = new HashMap<String, String>();
	private boolean debugging = false;
	private String basePath = "http://api.ima.sp.gov.br/v1";
